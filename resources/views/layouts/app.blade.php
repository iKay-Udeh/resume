...
<body class="bg-gray-100 h-screen antialiased leading-none font-sans">
    ...
    <footer class="bg-gray-700 py-10 mt-10">
        <div class="w-10/12 grid grid-cols-2 border-b-2 text-gray-100 m-auto border-gray-400 pb-5">
            <a href="#contact-me" class="uppercase">
                <div class="text-center m-auto border border-white w-full p-5 hover:bg-gray-400 hover-fill">
                    Contact me
                </div>
            </a>
            
            <div class="flex text-center m-auto w-full justify-center">
